...
def main():
    ...
    train_writer = tf.summary.FileWriter('summary/train_arch_01', session.graph)
    test_writer = tf.summary.FileWriter('summary/test_arch_01')

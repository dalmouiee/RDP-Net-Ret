'''
    ...
    Architrecture 08, refer to paper for further details
'''
...
def main():
    ...
    train_writer = tf.summary.FileWriter('summary/train_arch_08', session.graph)
    test_writer = tf.summary.FileWriter('summary/test_arch_08')

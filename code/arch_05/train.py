'''
    ...
    Architrecture 05, refer to paper for further details
'''
...
filter_size_conv5 = 3
num_filters_conv5 = 320
filter_size_conv6 = 3
num_filters_conv6 = 320
...
def train(session, data, x, y_true, cost, optimiser, accuracy, merged, val_accuracy,
            train_writer, test_writer, saver, num_iteration):
    total_iterations = 0
...
def main():
    ...
    train_writer = tf.summary.FileWriter('summary/train_arch_05', session.graph)
    test_writer = tf.summary.FileWriter('summary/test_arch_05')
    ...
    train(session, data, x, y_true, cost, optimiser, accuracy, merged, val_accuracy, 
            train_writer, test_writer, saver, num_iteration=2000)

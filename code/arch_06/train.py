'''
    ...
    Architrecture 06, refer to paper for further details
'''
...
def main():
    ...
    train_writer = tf.summary.FileWriter('summary/train_arch_06', session.graph)
    test_writer = tf.summary.FileWriter('summary/test_arch_06')
    ...
    train(session, data, x, y_true, cost, optimiser, accuracy, merged, val_accuracy, 
            train_writer, test_writer, num_iteration=2000)
    
    # Save a model checkpoint
    saver.save(session, './arch_06')

'''
    ...
    Architrecture 07, refer to paper for further details
'''
...
def main():
    ...
    train_writer = tf.summary.FileWriter('summary/train_arch_07', session.graph)
    test_writer = tf.summary.FileWriter('summary/test_arch_07')

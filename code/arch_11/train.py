...
def main():
    ...
    train_writer = tf.summary.FileWriter('summary/train_arch_11', session.graph)
    test_writer = tf.summary.FileWriter('summary/test_arch_11')
